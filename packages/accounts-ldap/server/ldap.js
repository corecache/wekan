...
export default class LDAP {
    ...
    getUserGroups(username, ldapUser){
        ...
        if (this.options.group_filter_group_member_attribute !== '') {
            let format_value = ldapUser[this.options.group_filter_group_member_format];
            if( format_value ) {
        ...
        let grp_identifier = this.options.group_filter_group_id_attribute || "cn";
        let groups = [];
        result.map(item => {
	...
	isUserInGroup(username, ldapUser) {
        ...
        let grps = this.getUserGroups(username, ldapUser);
